...
const SOURCE_META: Record<SourceId, { label: string; tone: string }> = {
  ...
  openverse: { label: 'Openverse', tone: 'bg-violet-600 text-white' },
  wikimedia: { label: 'Commons', tone: 'bg-cyan-700 text-white' },
    ...
    recordings: [
      {
        ...
        sourceItems: [
          { id: 'si-1', recordingId: 'rec-1', source: 'bilibili', externalId: 'BV1xx', publisher: '周杰伦音乐台', url: null, thumbnailUrl: null, qualityMetadata: null, attributionMetadata: null },
          { id: 'si-2', recordingId: 'rec-1', source: 'local', externalId: 'file-001', publisher: '本地曲库', url: null, thumbnailUrl: null, qualityMetadata: null, attributionMetadata: null },
        ],
      },
    ],
  },
    ...
    recordings: [
      {
        ...
        sourceItems: [
          { id: 'si-3', recordingId: 'rec-2', source: 'bilibili', externalId: 'BV2yy', publisher: '陈奕迅频道', url: null, thumbnailUrl: null, qualityMetadata: null, attributionMetadata: null },
          { id: 'si-4', recordingId: 'rec-2', source: 'open_source', externalId: 'arch-1', publisher: 'Internet Archive', url: null, thumbnailUrl: null, qualityMetadata: null, attributionMetadata: null },
        ],
      },
    ],
  },
    ...
    recordings: [
      {
        ...
        sourceItems: [
          { id: 'si-5', recordingId: 'rec-3', source: 'bilibili', externalId: 'BV3zz', publisher: '杰威尔音乐', url: null, thumbnailUrl: null, qualityMetadata: null, attributionMetadata: null },
        ],
      },
    ],
  },
